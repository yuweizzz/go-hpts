/*
   ...
   A test socks5 server with auth support for go-hpts
   from https://golangnote.com/topic/297.html
...
func main() {
	...
	username := flag.String("username", "username", "proxy auth username")
	password := flag.String("password", "password", "proxy auth password")
	flag.Parse()
